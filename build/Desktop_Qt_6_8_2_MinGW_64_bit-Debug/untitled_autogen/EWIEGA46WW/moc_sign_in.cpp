...
static constexpr auto qt_meta_stringdata_ZN7sign_inE = QtMocHelpers::stringData(
    "sign_in",
...
Q_CONSTINIT static const uint qt_meta_data_ZN7sign_inE[] = {
...
Q_CONSTINIT const QMetaObject sign_in::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7sign_inE.offsetsAndSizes,
    qt_meta_data_ZN7sign_inE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7sign_inE_t,
        // Q_OBJECT / Q_GADGET
...
void *sign_in::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7sign_inE.stringdata0))
